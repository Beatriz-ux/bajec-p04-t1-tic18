...
int main(void)
{
    ...
    cout << "Valor mánimo de int: " << INT_MIN << endl;

    cout << "B)" << endl;
    unsigned long int uli = ULONG_MAX;
    cout << "Valor máximo de unsigned long int: " << uli << endl;
    cout << "Valor máximo de unsigned long int: " << 0 << endl;
    ...
    cout << "Valor mánimo de long int: " << LONG_MIN << endl;
    ...
    // e por isso não houve troca de representaçãoes.

    cout << "F)" << endl;
    ui = ULONG_MAX;
    cout << "Valor máximo de unsigned int: " << ui << endl;
    cout << "Valor máximo de unsigned int: " << 0 << endl;
