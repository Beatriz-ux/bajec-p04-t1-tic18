...
int main(void)
{
    ...
    cout << "Convers�o de caracteres para bool" << endl;
    ...
    cout << "Convers�o de inteiros para bool" << endl;
    ...
    cout << "Convers�o de float para bool" << endl;
    ...
    cout << "Convers�o de double para bool" << endl;
